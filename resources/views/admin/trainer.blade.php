          ...
          @else
            <div class="row">
              <div class="grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h2>Untuk memilih Trainer, Anda harus menjadi Membership Kami terlebih dahulu. silahkan klik tombol di bawah ini untuk menjadi Membership Kami</h2>
                    <a href="/member" class="btn btn-primary">Jadi Membership</a>
                  </div>
                </div>
              </div>
            </div>
