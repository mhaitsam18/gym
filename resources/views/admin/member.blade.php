                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <br>
                            <h6 class="text-muted font-weight-normal"><p>Tentukan Paket membership Anda
                           dan pilihan apa yang Anda dapatkan</p></h6>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{url('/uploadmember1',$data->id)}}" method="post" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{url('/uploadmember2',$data->id)}}" method="post" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{url('/uploadmember3',$data->id)}}" method="post" enctype="multipart/form-data">
